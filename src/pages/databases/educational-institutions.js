...
import EducationalInstitutionsDialog from "../../components/databases/educational-institutions-dialog"
...
const EducationalInstitutions = () => {
        ...
        mutation: gql`
          mutation CreateLog {
            createLog(input: {
              data: {
                action: "view",
                description: "databases->educational-institutions",
  ...
  const getDataFromDB = useCallback(async () => {
    ...
    try {
      ...
      setTableOption(prev => ({
        ...prev,
        totalRows: total.data.educationalInstitutionsConnection.aggregate.count,
      }))

      if (total.data.educationalInstitutionsConnection.aggregate.count > 0) {
        ...
        let count = 0
        for (let row of res.data.educationalInstitutions) {
          count++
          returnData = [
            ...returnData,
            {
            ...
            <>
              ...
              <OparatorFlex>
                <div className="ft">
                  ...
                  >
                    <Chip
                      label={`ชื่อสถาบันการศึกษา: ${confirmedFilterInputs.name}`}
                      color="primary"
